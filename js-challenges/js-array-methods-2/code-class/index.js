...
/* map -> return a new Array and go through the array  */

/* filter -> we filter an array by a given criteria and return show copy  */

/* forEach -> loop the array one time. */

//   publishingYear > 1989.

//MAP:
const returnMap = games.map((game) => {
    return game.publishingYear > 1989 ? game : 'no game';
});

// console.log('with Map: ', returnMap);

// Filter

const returnFilter = games.filter((item) => item.publishingYear > 1989);

// console.log('With Filter: ', returnFilter);

// Include -> given value is present. Only for arrays, returns true or false

const names = ['Maria', 'Gimena', 'Czarnievicz', 'Inciarte', 'Canavesil'];

const returnInclude = names.includes('maria');

// names.forEach((element, index) => {
//     console.log('For each include', element.toLowerCase().includes('maria'));
//     console.log('index: ', index);
// });

console.log('Return Include: ', returnInclude);

// findIndex -> find the index of a given element.
const returnFindIndex = names.findIndex((element) => element === 'inciarte');

console.log('returnFindIndex: ', returnFindIndex);
console.log('returnFindIndex typeof: ', typeof returnFindIndex);

// find or include.
const returnFind = names.find((elem) => elem === 'gimena');

console.log('return Find: ', returnFind);
