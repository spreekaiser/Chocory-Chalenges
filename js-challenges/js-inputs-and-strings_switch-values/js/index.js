...
switchButton.addEventListener("click", () => {
  ...
  let switchInput = secondInput.value;
  if (switchInput === switchInput.toUpperCase()) {
    secondInput.value = switchInput.toLowerCase();
  }
  if (switchInput === switchInput.toLowerCase()) {
    secondInput.value = switchInput.toUpperCase();
  }
});
